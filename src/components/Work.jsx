...
const works = [
  { imgSrc: '/images/p1.png', title: 'Dr. Appointment', tags: ['React', 'Full Stack'], projectLink: '#' },
...
const Work = () => {
  ...
  return (
    <section className="py-12 md:py-24 bg-zinc-950 relative overflow-hidden" id="work">
